...
import { LineChart, Line, BarChart, Bar, PieChart, Pie, Cell, AreaChart, Area, RadarChart, Radar, PolarGrid, PolarAngleAxis, ResponsiveContainer, XAxis, YAxis, CartesianGrid, Tooltip, Legend, PolarRadiusAxis } from 'recharts'
...
export function DetailedStatisticsComponent() {
        ...
        <CardHeader className="flex flex-col space-y-4">
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-2">
              ...
              <Button onClick={handleExport} variant="outline" size="sm" className="bg-white/50 hover:bg-white/70 rounded-full">
                <Download className="mr-1 h-4 w-4" /> Exporter les données
              </Button>
            </div>
          </div>
